...
class Experiment():
    def __init__(self, age, test_result_1, test_result_2, test_result_3):
        self.age = age
        self.test_result_1 = test_result_1
        self.test_result_2 = test_result_2
        self.test_result_3 = test_result_3
